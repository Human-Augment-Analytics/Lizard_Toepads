#!/usr/bin/env python3
"""
Train shape predictor on cropped toe images using best parameters from hyperparameter search.
"""
...
def main():
    parser = argparse.ArgumentParser(
        description='Train shape predictor on cropped toe images with best parameters'
    )
    parser.add_argument(
        '--train-xml',
        type=str,
    ...
    parser.add_argument(
        '--output',
        type=str,
        default='toe_predictor_cropped.dat',
        help='Output model filename (default: toe_predictor_cropped.dat)'
    )
    parser.add_argument(
        '--params-file',
        type=str,
